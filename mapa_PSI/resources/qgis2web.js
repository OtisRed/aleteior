...
map.getView().fit([1657634.862014, 6314826.405121, 2471569.697390, 6853758.106755], map.getSize());
...
var onSingleClick = function(evt) {
    ...
    map.forEachFeatureAtPixel(pixel, function(feature, layer) {
        ...
        if (doPopup) {
            ...
            popupText += '<tr><td colspan="2"><strong>Powiat:</strong></td> ' + '<td style="text-align:right">' + powiat + "</td></tr>";

            var bezrobocie = String(feature.get("unemployment_rate_class_with_woj_unemployment_ratio"));
            popupText += '<tr><td colspan="2"><strong>Bezrobocie: </strong></td>' + '<td style="text-align:right">' + bezrobocie + "</td></tr>";
